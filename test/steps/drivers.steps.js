...
module.exports.validateDriversName = async function (myApp,  driverTestCase) {
   ...
   return await 
     element(driversPage.licenseField).isFocused();
};

//This method is to add a driver
module.exports.addDriver = async function (myApp, driverTestCase) {
...
module.exports.validateHighlightedDriver = async function (myApp, testCase, menuTestCase, driverTestCase) {
